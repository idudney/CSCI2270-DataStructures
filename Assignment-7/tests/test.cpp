...
{
    string desired = readFileIntoString("/Users/isabeldudney/Development/CSCI2270/Homeworks/assignment-7-idudney/output1.txt");
    string resp = exec("./run_app_1 /Users/isabeldudney/Development/CSCI2270/Homeworks/assignment-7-idudney/shows1.csv /Users/isabeldudney/Development/CSCI2270/Homeworks/assignment-7-idudney/input1.txt");
    ASSERT_EQ(desired, resp);
    add_points_to_grade(9);
    
    string desired2 = readFileIntoString("/Users/isabeldudney/Development/CSCI2270/Homeworks/assignment-7-idudney/output2.txt");
    string resp2 = exec("./run_app_1 /Users/isabeldudney/Development/CSCI2270/Homeworks/assignment-7-idudney/shows2.csv /Users/isabeldudney/Development/CSCI2270/Homeworks/assignment-7-idudney/input2.txt");
    
    ASSERT_EQ(desired2, resp2);
    add_points_to_grade(9);
    
    string desired4 = readFileIntoString("/Users/isabeldudney/Development/CSCI2270/Homeworks/assignment-7-idudney/output3.txt");
    string resp4 = exec("./run_app_1 /Users/isabeldudney/Development/CSCI2270/Homeworks/assignment-7-idudney/shows.csv /Users/isabeldudney/Development/CSCI2270/Homeworks/assignment-7-idudney/input3.txt");
